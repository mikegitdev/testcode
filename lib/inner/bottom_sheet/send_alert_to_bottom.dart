                  ...
                  SizedBox(
                    ...
                    child: ListView(
                      children: [
                        ...
                        controller.createdUser != null && controller.createdUser!.isNotEmpty
                            ? Column(
                          children: [
                            24.verticalSpace,
                            Text(
                              ...
                              child: GridView.builder(
                                ...
                                itemBuilder: (BuildContext ctx, index) {
                                  return GestureDetector(
                                    onTap: () {
                                      update(() {
                                        controller.chooseUser(controller.createdUser![index]);
                                      });
                                    },
                                    child: UserSingle(
                                      object: controller.createdUser![index],
                                    ),
                                  );
                                },
                                itemCount:
                                controller.createdUser?.length,
                              ),
                            ),
                          ],
                        )
